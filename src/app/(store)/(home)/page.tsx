  ...
  return (
    <div className="grid max-h-[660px] grid-cols-9 grid-rows-6 gap-6">
      ...
      >
        ...
        <div className="absolute bottom-28 right-28 flex h-12 max-w-[200] items-center gap-2 rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
      ...
      {otherProducts.map((product) => {
        return (
          ...
          >
            ...
            <div className="absolute bottom-10 right-10 flex h-12 max-w-[200] items-center gap-2 rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
